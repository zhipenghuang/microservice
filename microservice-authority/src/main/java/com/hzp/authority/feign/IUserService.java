package com.hzp.authority.feign;

import com.hzp.authority.configuration.FeignConfiguration;
 ...
 */
@FeignClient(value = "microservice-admin",configuration = FeignConfiguration.class)
